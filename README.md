...
<------ TODO: сюда скомпилить справку по элементам лэйаута
Лэйаут типа 'strip' должен иметь свойства 'orient' (со значением 'v' или 'h') и items. Свойство 'items' представляет собой массив
